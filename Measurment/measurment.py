...
PPM_TOP = 3.5250   #change according to your result 
PPM_SIDE = 16.9000 #change according to your result 
...
def visualize_measurements(image, shape_type, main_contour, children, measurements):
    ...
    if shape_type == "cylinder":
        ...
        id_contour = None
        bolt_hole_contours = []
        origin_xy = (int(x_main), int(y_main))  
...
if __name__ == "__main__":
    ...
    parser.add_argument('--left', help="Path to left (side) view image")  
